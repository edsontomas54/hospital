    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          {{-- <a href="index.html" class="app-brand-link"> --}}
            ...
            {{-- <span class="app-brand-text  text-lg-center fw-bold ms-2">CSSD</span> --}}
          {{-- </a> --}}
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item active open">
            <a href="{{route('admin.dashboard')}}" class="menu-link menu-toggle">
              ...
              <div data-i18n="Dashboards">CSSD Painel de Contolo</div>
              {{-- <div class="badge bg-danger rounded-pill ms-auto">5</div> --}}
            </a>
            <ul class="menu-sub">
              <li class="menu-item active">
                <a href="{{route('admin.dashboard')}}" class="menu-link">
                  <div data-i18n="Analytics">Estatísticas</div>
                </a>
              </li>
            </ul>
          </li>
          ...
          {{-- <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <div data-i18n="Layouts">Views</div>
            </a>
          ...
          @if (Auth::check() && Auth::user()->role=="ADMIN" || Auth::user()->role !="PATIENT")
          <li class="menu-item ">
              <a href="{{route('admin.view.appointments')}}" class="menu-link">
              <div data-i18n="Without menu">Marcações</div>
              </a>
          </li>
          @endif
