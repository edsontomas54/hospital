<div>
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        @if (Auth::user()->role==RoleEnum::DOCTOR)
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" {{ Auth::user()->availability ? 'checked' : '' }}>
              ...
              <a class="dropdown-item" href="#">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <small class="text-muted">{{$user->role !=null ? RoleEnum::getPortugueseLabel($user->role) : "no user logged"}}
                      {{-- {{$user->is_admin ===1 ? RoleEnum::getPortugueseLabel($user->role) : ""}} --}}
                    </small>
                  </div>
                </div>
              </a>
